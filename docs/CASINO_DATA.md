...
> the original plan, not the live build. Shipped games: Hex Roulette (cover 1-5
> of 6 hexes, floor(20/N)x — 20x on one hex down to 4x on five), Dream Dice
> (call the 2d6 total, 2x, 3x on doubles), Payback Pyramid (even/odd d6,
